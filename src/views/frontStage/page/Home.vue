            ...
            <div class="level1-1">
                <div class="block" style="padding: 20px 40px 20px 60px;">
                    <el-carousel height="360px" >
                        <el-carousel-item v-for="u in url" :key="u" interval="3000">
                            <el-image :src="u" style="height: 100%;width: 714px"></el-image>
                        </el-carousel-item>
                    </el-carousel>
                </div>
            </div>
            <div class="level1-2">
                <div class="level1-2-1" style="padding: 20px;height: 90%;width: 93%">
                    <el-card class="box-card" shadow="hover">
                        ...
                        <div v-for="a in announcement" :key="a.index" class="text item">
                            ...
                            <router-link :to="{path:'announcement', query: { id: a.id }}" class="announcementContent" > {{ a.title }}</router-link>
                            <span style="float: right;display: inline-block;white-space: nowrap;width: 76px;overflow: hidden;">{{ a.createDate }}撑开专用</span>
                        </div>
                    </el-card>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            url:[
                'http://chickweb.oss-cn-beijing.aliyuncs.com/files/%E5%9C%A8%E7%BA%BF%E5%B7%A5%E5%85%B7.png',
                'http://chickweb.oss-cn-beijing.aliyuncs.com/files/%E8%BD%AF%E4%BB%B6%E4%B8%8B%E8%BD%BD.png',
                'http://chickweb.oss-cn-beijing.aliyuncs.com/files/%E5%B8%96%E5%AD%90.png',
                'http://chickweb.oss-cn-beijing.aliyuncs.com/files/%E8%A7%82%E5%BD%B1.png'
            ],
